...
class OrderStateMachineIntegrationTest extends BaseIntegrationTest {
    ...
    void testCannotAccessOtherTenantOrder() throws Exception {
        ...
        // Should be forbidden (403) or not found (different tenant context returns 200 with 10403).
        ...
        assertTrue(
                status == 403 || status == 404 || content.contains("\"code\":403") || content.contains("\"code\":404") || content.contains("\"code\":10403"),

        ...
        items={[
            ...
            children: (
              <div>
                ...
                <Table
                  ...
                  dataSource={specialDatesData?.data || []}
                  rowKey="id"
          ...
          },
          {
            ...
            children: (
              <Form
                layout="vertical"
                initialValues={{
                  coefficients: levelCoefData?.data || levelLabels.map((_, i) => ({
                    level: i + 1,
                    coefficient: 1 + i * 0.2,
                  })),
                }}
          ...
          },
          {
            ...
            children: (
              <Form
                layout="vertical"
                initialValues={{ maxPoints: dailyCapData?.data?.maxPoints || 500 }}

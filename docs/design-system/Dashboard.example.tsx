/**
 * Carbon Point Design System - Dashboard 示例
 * 使用新的液态玻璃设计系统重新设计的 Dashboard
 *
 * 对比原版: apps/enterprise-frontend/src/pages/Dashboard.tsx
 */

import React, { useState } from 'react';
import { Card, Table, Progress, Empty, Button, Flex, Space, Typography } from 'antd';
import {
  TeamOutlined,
  TrophyOutlined,
  ShoppingOutlined,
...
// 设计系统颜色（替代原有 CHART_COLORS）
const CHART_COLORS = {
  primary: { start: '#6366F1', end: '#8B5CF6' },    // 靛蓝紫
  secondary: { start: '#10B981', end: '#34D399' },   // 翠绿
  accent: { start: '#F59E0B', end: '#FBBF24' },      // 琥珀
  tertiary: { start: '#EC4899', end: '#F472B6' },    // 粉色
};
                        ...
                        background:
                          index === 0
                            ...
                            : index === 1
                              ...
                              : index === 2
                                ? 'linear-gradient(135deg, #CD7F32, #E5A66B)'
 ...
 * | 原版 | 新版 |
 * |------|------|
 * | antd Card | GlassCard + GlassCardStat |
 * | Row/Col 布局 | BentoGrid 网格布局 |
 * | 无 | InsightBanner 智能洞察 |
 * | 无 | NaturalLanguageQuery 自然语言查询 |
 * | 固定颜色 | 设计系统 Token |
 * | 无 | 液态玻璃动效 |
 *
 * 主要改动:
 * 1. GlassCard 替代 Card，添加 backdrop-filter 模糊效果
 * 2. BentoGrid 实现灵活的网格布局
 * 3. GlassCardStat 专用的统计卡片组件
 * 4. InsightBanner 添加智能洞察轮播
 * 5. NaturalLanguageQuery 添加自然语言数据查询
 * 6. 整体色调统一为深色液态玻璃风格
 */

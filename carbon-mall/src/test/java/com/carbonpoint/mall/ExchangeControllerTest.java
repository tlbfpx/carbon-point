...
class ExchangeControllerTest extends BaseIntegrationTest {
    ...
    void testGetOrderForbiddenForOtherUser() throws Exception {
        ...
        // Should be forbidden
        assertTrue(
                content.contains("\"code\":403") || content.contains("\"code\":10403") ||
                content.contains("Forbidden") || content.contains("SYSTEM004"),
                "Other user's order should be forbidden, got: " + content
        );
    }
